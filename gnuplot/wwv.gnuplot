...
set size 0.4,0.45
set origin 0.0,0.55
plot '~/.xdx/DK0WCY-3.tsv' \
  using 1:2 smooth csplines with lines notitle

set title "A Index"
set size 0.4,0.45
set origin 0.5,0.55
plot '~/.xdx/DK0WCY-3.tsv' \
  using 1:3 smooth csplines with lines notitle

set title "K Index"
set size 0.4,0.45
set origin 0.0,0.05
plot '~/.xdx/DK0WCY-3.tsv' \
  using 1:4 smooth csplines with lines notitle

set title "Sunspot number"
set size 0.4,0.45
set origin 0.5,0.05
plot '~/.xdx/DK0WCY-3.tsv' \
  using 1:5 smooth csplines with lines notitle
